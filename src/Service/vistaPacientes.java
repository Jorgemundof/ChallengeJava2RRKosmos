...
public class vistaPacientes extends javax.swing.JFrame {
    ...
    String[] Campos_tabla = {"Nombres", "Apellidos", "Edad", "Dirección", "Télefono"};
    String[] informacion = new String[50];

    public void mostrar_pacientes() {

        //Query para para realizar la consulta en la base de datos...
        String Query = "SELECT nombres, apellidos, edad, direccion, telefono FROM pacientes";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista Pacientes", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 18))); // NOI18N
        ...
        tabla_pacientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombres", "Apellidos", "edad", "Direccion", "Telefono"
            }
        ) {
        ...
        if (tabla_pacientes.getColumnModel().getColumnCount() > 0) {
            tabla_pacientes.getColumnModel().getColumn(0).setHeaderValue("Nombres");
            tabla_pacientes.getColumnModel().getColumn(1).setHeaderValue("Apellidos");
            tabla_pacientes.getColumnModel().getColumn(2).setMinWidth(50);
            tabla_pacientes.getColumnModel().getColumn(2).setPreferredWidth(50);
            tabla_pacientes.getColumnModel().getColumn(2).setMaxWidth(50);
            tabla_pacientes.getColumnModel().getColumn(2).setHeaderValue("edad");
            tabla_pacientes.getColumnModel().getColumn(3).setHeaderValue("Direccion");
            tabla_pacientes.getColumnModel().getColumn(4).setHeaderValue("Telefono");
        }
    ...
    private void tabla_pacientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_pacientesMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            registrarCita.txt_client.setText(tabla_pacientes.getModel().getValueAt(columna, 1).toString() + " "
