...
public class listaPacientes extends javax.swing.JFrame {
    ...
    String[] Campos_tabla = {"Id", "Nombres", "Apellidos", "Edad", "Dirección", "Télefono"};
    ...
    private void initComponents() {
        ...
        tabla_pacientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombres", "Apellidos", "edad", "Direccion", "Telefono"
            }
        ) {
    ...
    private void tabla_pacientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_pacientesMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            registrarPacientes r = new registrarPacientes();
            r.setVisible(true);

            registrarPacientes.txt_id.setText(tabla_pacientes.getModel().getValueAt(columna, 0).toString());
            registrarPacientes.txt_name.setText(tabla_pacientes.getModel().getValueAt(columna, 1).toString());
            registrarPacientes.txt_lastname.setText(tabla_pacientes.getModel().getValueAt(columna, 2).toString());
            registrarPacientes.txt_age.setText(tabla_pacientes.getModel().getValueAt(columna, 3).toString());
            registrarPacientes.txt_address.setText(tabla_pacientes.getModel().getValueAt(columna, 4).toString());
            registrarPacientes.txt_phone.setText(tabla_pacientes.getModel().getValueAt(columna, 5).toString());

            registrarPacientes.btn_register.setEnabled(false);
            registrarPacientes.btn_update.setEnabled(true);
            registrarPacientes.btn_delete.setEnabled(true);
