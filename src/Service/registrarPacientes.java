...
public class registrarPacientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro de Pacientes", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 18))); // NOI18N
    ...
    private void btn_calcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcelActionPerformed
        ...
        //llamado de un metódo de otra interfaz
        listaPacientes a = new listaPacientes();
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        try {
            ...
            PreparedStatement pps = conectar.prepareStatement("DELETE FROM pacientes WHERE id ='" + txt_id.getText() + "'");
            //ejecutamos query
            pps.execute();
            //Mensaje 
